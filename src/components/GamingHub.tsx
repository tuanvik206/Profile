        ...
        >
          ...
          <div className="flex-1 overflow-hidden min-h-0 flex flex-col">
            {activeTab === "favorite" ? (
              ...
              <div className="flex-1 flex flex-col lg:flex-row gap-6 min-h-0 overflow-y-auto lg:overflow-hidden pr-1 pb-4 custom-scrollbar">
                {/* Left Column: Player Identity Card */}
                <div className="w-full lg:w-[350px] xl:w-[400px] shrink-0 flex flex-col gap-4">
                  <div className="border border-white/10 bg-white/[0.01] p-5 sm:p-6 relative overflow-hidden flex flex-col justify-start gap-5 h-full group">
